    ...
    {/* navbar */}
      ...
      <div className='bg-[#008280] flex justify-between items-center'>
        <div className=' text-white font-semibold text-5xl ml-72'>
          <h1 className='mb-5 text-[#071645]'>Welcome to <span className='text-white'>DevSync</span></h1>
      ...
      <div className='bg-[#071645] w-52 min-h-[120vh] max-h-[130vh] absolute top-20'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <NavLink to = {`/Student/Dashboard/${ID}/ViewCourse`} className={({isActive}) => isActive ? "bg-white p-3 px-[4.61rem] text-center font-semibold text-[#4E84C1]" : "p-3 text-center font-semibold text-[#4E84C1]" }> 
          Get_Courses
          </NavLink>

          <NavLink to = {`/Student/Dashboard/Quiz`} className={({isActive}) => isActive ? "bg-white p-3 px-[4.61rem] text-center font-semibold text-[#4E84C1]" : "p-3 text-center font-semibold text-[#4E84C1]" }> 
          Qizes(Test your knowledge)
          </NavLink>
        </div>
