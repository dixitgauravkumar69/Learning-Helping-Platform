  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">DevSync</span>
          </h1>
          {/*  Search  */}
          ...
          <div className="search mb-10">
            ...
            <input type="text" placeholder='Ex: Fullstack ...' value={subject} onChange={(e)=>setSubject(e.target.value)}/>
      ...
      <div className="features ">
        ...
        <div className="fets2">
          ...
          <div className="fet cursor-pointer mb-5" onClick={BB}>
            <img
              src="https://i.pinimg.com/736x/64/29/47/642947a1bd533b51842a8fb789699b69.jpg"
              alt=""
            />
      ...
      <div className="about" style={{backgroundColor: "#042439"}}>
        ...
        <div className="content">
          ...
          <p>
            At Devsync, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
